...
// private helper functions to render the cards
 ...
 * @param {HTMLElement} pullRequestsList - The DOM element to render the pull requests into.
 */
export async function displayPullRequests(pullRequests, pullRequestsList, lastViewedTime=null, elementId = null) {
    // Hide all tab content
    const allTabContents = document.querySelectorAll('.tab-content');
    allTabContents.forEach((content) => {
        content.classList.add('hidden');
